...
public class NetworkUtils {
    ...
    private static final String LOG_TAG = NetworkUtils.class.getSimpleName(); //log tag
    ...
    //example of url call https://www.googleapis.com/books/v1/volumes?q=harry potter&maxResults=2&printType=books
...
// Stream was empty. No point in parsing.
        ...
        Log.d(LOG_TAG, "JASON_________"+bookJSONString);
